  ...
  const { data: workshops = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        .from('workshops')
        .select('id, title, slug, short_description, thumbnail_url, start_date, end_date, start_time, end_time, max_participants, status, fake_registration_count, instructor_name, instructor:user_profiles!workshops_instructor_id_fkey(id, full_name, avatar_url)')
