...
import { Upload as UploadIcon, Search, Trash2, Copy, Grid, List, Image as ImageIcon, File } from 'lucide-react';
          ...
          {selectedMedia && (
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><span className="text-muted-foreground">Type:</span> {selectedMedia.file_type}</p>
