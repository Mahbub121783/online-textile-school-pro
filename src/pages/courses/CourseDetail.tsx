    ...
    <div className="min-h-screen flex flex-col">
      <SEOHead
        ...
        jsonLd={{
          ...
          url: `https://www.onlinetextileschool.com/courses/${course.slug}`,
          ...
          offers: { '@type': 'Offer', price: finalPrice, priceCurrency: 'BDT', availability: 'https://schema.org/InStock', url: `https://www.onlinetextileschool.com/courses/${course.slug}` },
          courseMode: 'Online',
