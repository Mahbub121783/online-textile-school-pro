  ...
  const { data: courses = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data } = await supabase
        .from('courses')
        .select('id, title, slug, price, discount_price, avg_rating, enrollment_count, total_duration_minutes, difficulty_level, thumbnail_url, category_id, categories(name), user_profiles!courses_instructor_id_fkey(full_name)')
